...
import {CONST, isPresent, isBlank, Math} from 'angular2/facade';
...
@View({
  templateUrl: '/packages/barbatus_ng2-material/src/components/progress-linear/progress_linear.html',
  directives: [],
