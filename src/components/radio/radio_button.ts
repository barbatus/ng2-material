...
import {isPresent, StringWrapper, NumberWrapper} from 'angular2/facade';
import {ObservableWrapper, EventEmitter} from 'angular2/facade';
import {Event, KeyboardEvent} from 'angular2/facade';
...
@View({
  templateUrl: '/packages/barbatus_ng2-material/src/components/radio/radio_group.html',
  encapsulation: ViewEncapsulation.None
})
export class MdRadioGroup implements OnChanges, AfterViewInit {
...
@View({
  templateUrl: '/packages/barbatus_ng2-material/src/components/radio/radio_button.html',
  directives: [],
  encapsulation: ViewEncapsulation.None
})
