...
import {ObservableWrapper, Promise, PromiseWrapper} from 'angular2/facade';
import {isPresent, Type} from 'angular2/facade';
import {BrowserDomAdapter} from 'angular2/dom';

const DOM = new BrowserDomAdapter();

import {MouseEvent, KeyboardEvent} from 'angular2/facade';
...
@View({
  ...
  templateUrl: '/packages/barbatus_ng2-material/src/components/dialog/dialog.html',
