...
import {TimerWrapper, isPresent} from 'angular2/facade';
...
@View({
  templateUrl: '/packages/barbatus_ng2-material/src/components/button/button.html',
...
@View({
  templateUrl: '/barbatus_ng2-material/src/components/button/button.html',
  encapsulation: ViewEncapsulation.None
})
