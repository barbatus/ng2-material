...
import {ListWrapper, StringWrapper, isPresent, isString, NumberWrapper} from 'angular2/facade';
import {Math} from 'angular2/facade';
...
@View({
  templateUrl: '/packages/barbatus_ng2-material/src/components/grid_list/grid_list.html',
...
@View({
  templateUrl: '/packages/barbatus_ng2-material/src/components/grid_list/grid_tile.html',
  encapsulation: ViewEncapsulation.None
})
